...
class DataLoader:
    ...
    def __init__(self, batch_size, shuffle=False, img=""):
        self.X_train = None
        self.y_train = None
        self.img_mean = None
    ...
    def load_data(self):
        ...
        gesture.append(image_array)
        # train_data = image_array
        # val_data = image_array
        # gesture = []
        # gesture.append(plt.imread(self.img).reshape([128,128,1]))
